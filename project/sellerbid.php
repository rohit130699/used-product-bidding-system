...
<?php
$sql="select pid,category,brand,first_img,bsprice,updatedprice from product where seller=?";
$stmt=mysqli_stmt_init($con);
if(mysqli_stmt_prepare($stmt,$sql)){
	mysqli_stmt_bind_param($stmt,"s",$name);
	mysqli_stmt_bind_result($stmt,$pid,$cat,$brand,$img,$price,$updprice);
...
<tr>
   <th>IMAGE</th><th>CATEGORY</th><th>BRAND</th><th>BASE PRICE</th><th>CURRENT PRICE</th><th></th>
</tr>
<?php
...
while(mysqli_stmt_fetch($stmt)){
		...
		echo "<td class='cell'>₹$updprice</td>";
		echo "<td class='cell'><a href='deletebids.php?id=".$pid."'><button>VIEW</button></a></td>";
		echo "</tr>";
}}
else{
?>
