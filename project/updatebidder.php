...
<body>
<?php			 
$sql="select fname,lname,gmail,gender,c_no,age,upass from bidder where uname=?";
...
<div class="box">
            <h1>UPDATE HERE</h1>
            <form action="update_bid.php" name="f1" onsubmit="return update_test()" method="post">
                <p>FIRSTNAME  :
           ...
           return true;
                 ...
                 <center><input type="submit" value="UPDATE" onclick="submit">&nbsp;&nbsp;
                     <button  type="button" onclick="window.location='bidder.php'">BACK</button></center>
            </form>
        </div>
    </body>
</html>