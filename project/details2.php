...
<center><a href="img_gal.php?id=<?php echo $p1; ?>&type=<?php echo $type; ?>&LAPTOP=<?php echo $lap; ?>&DESKTOP=<?php echo $desk; ?>&PENDRIVE=<?php echo $pd; ?>&CAMERA=<?php echo $cam; ?>&MOBILE=<?php echo $mob; ?>"><button>VIEW IMAGE GALLERY</button></a></center><br><br>
...
<textarea cols="40" rows="4" readonly><?php echo $description; ?></textarea>&emsp;&emsp;&nbsp;&nbsp;<a href="bid.php?id=<?php echo $p1; ?>&price=<?php echo $upprice; ?>&type=<?php echo $type; ?>&LAPTOP=<?php echo $lap; ?>&DESKTOP=<?php echo $desk; ?>&PENDRIVE=<?php echo $pd; ?>&CAMERA=<?php echo $cam; ?>&MOBILE=<?php echo $mob; ?>"><button id="btn1">BID NOW</button></a>&emsp;&emsp;
<a href="bidding.php?type=<?php echo $type; ?>&LAPTOP=<?php echo $lap; ?>&DESKTOP=<?php echo $desk; ?>&PENDRIVE=<?php echo $pd; ?>&CAMERA=<?php echo $cam; ?>&MOBILE=<?php echo $mob; ?>"><button id="btn" >BACK</button></a>
</div>
</body>
</html>